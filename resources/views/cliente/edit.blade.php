                            ...
                            <div id="tab-1" class="cx-tab">
                                ...
                                <div class="rows pb-4">
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-campo" name="nome"
                                            placeholder="Digite aqui...">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label class="text-label">Nome Fantasia</label>
                                        <input type="text" class="form-campo" name="nome_fantasia">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">CPF</label>
                                        <input type="text" class="form-campo" name="cpf">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Data Cadastro</label>
                                        <input type="date" class="form-campo" name="data_cadastro">
                                    </div>
                                    <div class="col-8 mb-3">
                                        <label class="text-label">E-mail</label>
                                        <input type="email" class="form-campo" name="email">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Senha</label>
                                        <input type="password" class="form-campo" name="senha">
                                    </div>
                                    ...
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="text" name="fone" class="form-campo">
                                    </div>
                                    <div class="col-4 mb-3">
                            ...
                            <div id="tab-2" class="cx-tab">
                                ...
                                <div class="rows pb-4">
                                    <div class="col-3 mb-3">
                                        ...
                                        <input type="text" class="form-campo busca_cep" name="cep">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label class="text-label">Logradouro</label>
                                        <input type="text" class="form-campo rua" name="logradouro"
                                            placeholder="Digite aqui...">
                                    </div>
                                    <div class="col-2 mb-3">
                                        <label class="text-label">Número</label>
                                        <input type="text" class="form-campo" name="numero">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Complemento</label>
                                        <input type="text" class="form-campo" name="complemento">
                                    </div>
                                    <div class="col-3 mb-3">
                                        <label class="text-label">Bairro</label>
                                        <input type="text" class="form-campo bairro" name="bairro">
                                    </div>
                                    ...
                                    <div class="col-2 mb-2">
                                        ...
                                        <input type="text" class="form-campo estado" name="uf">
                                    </div>
                                    <div class="col-2 mb-2">
                                        <label class="text-label">IBGE</label>
                                        <input type="text" class="form-campo ibge" name="ibge">
                                    </div>
                            ...
                            <div id="tab-3" class="cx-tab">
                                ...
                                <div class="rows pb-4">
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="text" class="form-campo" name="ie"
                                            placeholder="Digite aqui...">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Insc. Municipal</label>
                                        <input type="text" class="form-campo" name="im">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Suframa</label>
                                        <input type="text" class="form-campo" name="suframa">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">RG</label>
                                        <input type="text" class="form-campo" name="rg">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Cód. Estrangeiro</label>
                                        <input type="text" class="form-campo" name="cod_estrangeiro">
                                    </div>
                                    <div class="col-4 mb-2">
                                        <label class="text-label">IE Subst. Trib.</label>
                                        <input type="text" class="form-campo" name="ie_subt_trib">
                                    </div>
                                    <div class="col43 mb-3">
                                        <label class="text-label">Cidade</label>
